...
원 과제 보고서는 [문서2.pdf](문서2.pdf)로 함께 보관되어 있으며, 현재 README는 원본 과제 자료와 현재 빌드/배포 환경을 구분해 정리합니다.
...
원래 과제 코드의 클래스 구조와 변수명은 최대한 유지했습니다. 원 과제 보고서 자료는 기존 텍스트 파일 대신 [문서2.pdf](문서2.pdf)로 보관합니다. 현재 정리는 실행 가능성, GitHub 업로드, Qt 버전 및 플랫폼 차이로 생길 수 있는 빌드 문제를 줄이는 데 초점을 두었습니다.
